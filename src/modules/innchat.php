...
function innchat_dohook($hookname,$args){
	...
	case "innchatter":
		...
		$args[] = translate_inline("the elementary discord of being"); // "Das elementare Zerw�rfnis des Seins" no idea if that makes any sense in english. (Ok, it doesn't make sense in german too.) It's from a "J�germeister" commercial spot :)
		break;
	case "namechange":
	case "dragonkill":
